...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=14:antialias=true:autohint=true:style=Bold,Italic", "Symbols Nerd Font:size=20:antialias=true:autohint=true" };
